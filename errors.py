...
#### Generic fatal error
def fatal(ex):
	"""Call this when a fatal exception has occured and you want MySQLadm to stop
	executing further. This function will abort with a 500 HTTP error and will
...
def error500(error):
	...
	app.logger.error("""MySQLadm 500 handler called.
...
def error403(error):
	...
	"""
	return render_template('error.html',error=error,title="Permission Denied",message='You do not have permission to access this resource. Contact your system administrator if you believe you should have access.'), 403
